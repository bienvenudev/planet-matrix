      ...
      <div className="flex-1 flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-[420px] flex flex-col gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm text-[#5e567a]">or continue with email</span>
            <div className="flex-1 h-px bg-white/[0.07]" />
          </div>
          ...
          <form className="flex flex-col gap-4" onSubmit={e => e.preventDefault()}>
            <div className="flex flex-col gap-1.5">
              <label className="text-sm text-[#5e567a] font-medium uppercase tracking-widest">Email</label>
              <input
                type="email"
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center justify-between">
                ...
                <a href="#" className="text-sm text-[#b97bff] hover:underline">Forgot password?</a>
              </div>
              <input
                type="password"
                placeholder="••••••••"
